...
const BusinsCard = (props) => {
  return (
    <>
      <div className="container m-auto sm:px-0 px-4 flexStyle sm:flex-row flex-col-reverse z-10 py-20 gap-10">
          ...
          {props.content.companies ? (
            props.content.companies.map((logo, logoIndex) => (
              <div className="w-3/12 " key={logoIndex}>
                <img src={logo} alt="logo" className="m-auto object-cover " />
              </div>
            ))
          ) : (
