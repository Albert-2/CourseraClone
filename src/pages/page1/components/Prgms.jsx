...
const Prgms = (props) => {
  return (
    <div className="flex items-start justify-center flex-col rounded-md cursor-pointer shadow-[rgba(100,100,111,0.2)_0px_7px_29px_0px] overflow-hidden sm:min-w-[275px] min-w-full h-[400px]">
      <img
        src={props.detail.img}
        alt="image"
        className="w-full h-[50%] flex-1"
      />
      <div className="p-2 flex flex-col space-y-2 flex-1 w-full">
